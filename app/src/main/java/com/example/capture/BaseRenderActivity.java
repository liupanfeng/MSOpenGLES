...
import com.example.capture.camera.MSCameraUtil;
...
//            mByteFlowRender.setTransformMatrix(90, 1);
    ...
    public void updateGLSurfaceViewSize(Size previewSize) {
        Size fitSize = null;
        fitSize = MSCameraUtil.getFitInScreenSize(previewSize.getWidth(), previewSize.getHeight(), getScreenSize().getWidth(), getScreenSize().getHeight());
