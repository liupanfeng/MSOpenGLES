...
void BasicLightingSample::LoadImage(NativeImage *iamge) {
    if (iamge){
        m_RenderImage.width=iamge->width;
        m_RenderImage.height=iamge->height;
        m_RenderImage.format=iamge->format;
        NativeImageUtil::CopyNativeImage(iamge,&m_RenderImage);
    }
}
